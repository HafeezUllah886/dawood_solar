                        ...
                        <div class="row">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody id="products_list">
                                        ...
                                        <tr id="row_{{$id}}">
                                            ...
                                            <td class="no-padding"><input type="number" name="price[]" required step="any" value="{{$product->price}}" min="0" class="form-control text-center no-padding" oninput="updateChanges({{$id}})" id="price_{{$id}}"></td>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="scrap_amount" oninput="updateTotal()" id="scrap_amount" value="{{$sale->scrap_amount}}" step="any"  class="form-control no_zero">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                            ...
                            <div class="col-3 mt-2">
                                ...
                                <div class="form-group d-none paid mt-2">
                                    ...
                                    <input type="number" name="paid" id="paid" value="{{ $sale->payment }}" class="form-control">
                                </div>
                            </div>
            ...
            $.ajax({
                ...
                success: function(product) {
                    ...
                    if (found.length > 0) {
                        ...
                        html += '</select></td>';
                        html += '<td class="no-padding"><div class="input-group"><span class="input-group-text no-padding" id="stockValue_'+id+'">'+product.stock+'</span><input type="number" max="'+product.stock+'" name="qty[]" oninput="updateChanges(' + id +')" min="0" required step="any" value="1" class="form-control text-center no-padding" id="qty_' + id + '"></div></td>';
