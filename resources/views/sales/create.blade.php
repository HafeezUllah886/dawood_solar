                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="scrap_amount" oninput="updateTotal()" id="scrap_amount" step="any" value="0" class="form-control no_zero">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
            ...
            $.ajax({
                ...
                success: function(product) {
                    ...
                    if (found.length > 0) {
                        ...
                        html += '<td class="no-padding"><div class="input-group"><span class="input-group-text no-padding" id="stockValue_'+id+'">'+product.stock+'</span><input type="number" max="" name="qty[]" oninput="updateChanges(' + id +')" min="0" required step="any" value="1" class="form-control text-center no-padding" id="qty_' + id + '"></div></td>';
